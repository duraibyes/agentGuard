...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      "flex w-full min-w-0 flex-col gap-1 pt-1.5",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2.5 overflow-hidden rounded-md group-data-[collapsible=icon]:rounded-sm px-2.5 py-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding,background-color,color,box-shadow,transform] duration-150 hover:bg-[hsl(var(--primary-accent)/0.14)] hover:text-sidebar-accent-foreground hover:shadow-[inset_0_0_0_1px_hsl(var(--primary-accent)/0.28)] hover:-translate-y-[1px] focus-visible:ring-2 active:bg-[hsl(var(--primary-accent)/0.2)] active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-[hsl(var(--primary-accent)/0.18)] data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-[hsl(var(--primary-accent)/0.14)] data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-primary-accent",
  {
    variants: {
      variant: {
