...
function TableRowComponent<TData>({
  ...
  const isPeekSelected = Boolean(selectedRowId && selectedRowId === row.id);
  ...
  return (
    <TableRow
      ...
      className={cn(
        ...
        isPeekSelected ? "bg-[var(--table-row-selected-bg)]" : undefined,
        isPeekSelected
          ? "hover:bg-[var(--table-row-selected-hover-bg)]"
          : undefined,
