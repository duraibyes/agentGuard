  ...
  const columns: LangfuseColumnDef<ObservationsTableRow>[] = [
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://agentguard.dev/docs/observability/features/log-levels",
      },
      enableHiding: true,
      cell({ row }) {
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://agentguard.dev/docs/prompt-management/get-started",
      },
      size: 200,
      enableHiding: true,
      enableSorting,
    ...
    },
    {
      ...
      headerTooltip: {
        ...
        href: "https://agentguard.dev/docs/experimentation",
      },
      enableHiding: true,
      enableSorting,
      defaultHidden: true,
