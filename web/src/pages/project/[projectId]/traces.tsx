    ...
    return (
      <Page
        headerProps={{
          ...
          help: {
            description:
              "A trace represents a single function/api invocation. Traces contain observations. See [docs](https://agentguard.dev/docs/observability/data-model) to learn more.",
