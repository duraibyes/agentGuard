...
const CHANGELOG_URL = "http://localhost:3001/changelog";
      ...
      <div className="flex items-center gap-2 py-1.5 pl-3">
        ...
        <p className="flex flex-1 flex-row gap-1 text-sm">
          <span className="font-semibold">
            Faster Agent Guard experience enabled (preview).
          </span>{" "}
          Missing real-time data? Upgrade your Agent Guard SDK to the latest major
          version.{" "}
          <Link
            href={CHANGELOG_URL}
            target="_blank"
