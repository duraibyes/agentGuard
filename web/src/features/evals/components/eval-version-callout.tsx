    ...
    return {
      ...
      description: (
        <>
          ...
          <a
            href="https://agentguard.dev/docs/observability/sdk/upgrade-path"
            target="_blank"
      ...
      return {
        ...
        description: (
          <>
            ...
            once you upgrade.{" "}
            <a
              href="https://agentguard.dev/docs/evaluation/experiments/experiments-via-sdk#experiment-runner-sdk"
              target="_blank"
              rel="noopener noreferrer"
              className="text-dark-blue font-medium hover:opacity-80"
            >
    ...
    return {
      ...
      description: (
        <>
          ...
          <a
            href="https://agentguard.dev/faq/all/llm-as-a-judge-migration"
            target="_blank"
            rel="noopener noreferrer"
            className="text-dark-blue font-medium hover:opacity-80"
          >
