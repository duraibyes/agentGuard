...
export function IntroSection({
  ...
  //       The issue was that on global routes e.g., http://localhost:3001/setup, the entitlement
    ...
    <div className="mt-1 flex flex-col gap-6">
      <div className="flex flex-col gap-3">
        ...
        <RainbowButton asChild>
          <a
            href="http://localhost:3001/docs/ask-ai"
            target="_blank"
            rel="noopener"
          >
            Chat with AI
      ...
      <div className="flex flex-col gap-3">
        ...
        <Button asChild variant="outline">
          <a
            href={
              uiCustomization?.documentationHref ?? "http://localhost:3001/docs"
            }
            target="_blank"
            rel="noopener"
          >
          ...
          <div className="flex flex-col gap-3">
            ...
            {!uiCustomization?.supportHref && (
              <>
                <Button variant="outline" asChild>
                  <a
                    href="http://localhost:3001/ideas"
                    target="_blank"
                    rel="noopener"
                  >
                    Feature request
                ...
                <Button variant="outline" asChild>
                  <a
                    href="http://localhost:3001/issues"
                    target="_blank"
                    rel="noopener"
                  >
                    Report a bug
      ...
      {supportType === "community" && (
        <>
          <div className="flex flex-col gap-3">
            ...
            <Button variant="outline" asChild>
              <a
                href="http://localhost:3001/gh-support"
                target="_blank"
                rel="noopener"
              >
      ...
      {supportType !== "custom" && (
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Join the conversation and connect with the ShiftLeft Observe community.
          </p>
          <div className="mt-3 grid grid-cols-1 gap-2">
            ...
            <Button asChild variant="ghost" className="justify-start px-1.5">
              <a
                href="http://localhost:3001/discord"
                target="_blank"
                rel="noopener"
