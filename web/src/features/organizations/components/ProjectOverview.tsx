...
const DemoOrganizationTile = () => {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Try Agent Guard Demo</CardTitle>
      </CardHeader>
      <CardContent>
        Use this demo project to quickly validate your Agent Guard setup and
        see traces flowing in your dashboard.
      </CardContent>
      <CardFooter>
        <Button asChild variant="secondary">
      ...
      <CardContent>
        <CardDescription>
          {canCreateOrgs
            ...
            : "You need to get invited to an organization to get started with Agent Guard."}
        </CardDescription>
      </CardContent>
